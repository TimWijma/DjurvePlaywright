...
test('Check activity', async ({ page, browser }) => {
  const context = await browser.newContext()

  page.goto(Global.url + '&deeplink=registration&machinechecklistid=61ca13be-98bc-0001-8bd1-454f215dd1a3')
  ...
  await page.click(Activities['Clean And Check'].ActivityCheck_Goed)
